...
import Hero from "@/components/ai-detection/Hero";
      ...
      <div className="min-h-screen w-full h-full flex flex-col z-0 items-center relative bg-gradient-to-b from-[#0C0F15] to-[#0C0F16]">
        ...
        <div className="flex pt-32 flex-col bg-gradient-to-b from-[#040508] to-[#0C0F15] bg-transparent justify-center items-center w-full relative">
          ...
          <p className="text-sm font-light mt-8">
            Discover how we help organizations detect deepfakes, prevent fraud, and verify human authenticity.
          </p>

          <div className="grid grid-cols-3 bp1:grid-cols-2 bp6:grid-cols-1 mt-14 gap-4 mb-10">
            <Grid2
              text="The deepfake detection capability is a lifesaver. We caught a sophisticated video impersonation attempt before it could damage our reputation."
              name="CISO at a Fintech Company"
            />
            <Grid2
              text="Ensuring our codebase is free from malicious AI-generated patterns has never been easier. The code integrity scans are fast and accurate."
              name="CTO at a Software Firm"
            />
            <Grid2
              text="Identity verification is now seamless and secure. We've reduced fraudulent account creations by 90% thanks to the biometric cross-referencing."
              name="Head of Trust & Safety at a Social Platform"
            />
            <Grid2
              text="Real-time fraud prevention blocked thousands of bot attacks during our last launch. The API integration was straightforward and incredibly effective."
              name="VP of Engineering at an E-commerce Giant"
            />
            <Grid2
              text="Synthetic voice detection helped us identify and block a major vishing campaign targeting our support team. Essential tool for modern security."
              name="Security Operations Manager at a Bank"
            />
            <Grid2
              text="Finally, a tool that distinguishes human creativity from AI noise. It's helped us maintain the authenticity of our user-generated content platform."
              name="Community Director at a Media Company"
            />
          </div>
        </div>
          ...
          <div className="w-[80%] mt-10  mb-10 gap-20 flex bp7:flex-col flex-row items-center justify-evenly">
            <div className="flex  flex-col relative ">
              ...
              <div className="mt-8 flex flex-row gap-3 items-end">
                ...
                <p className="font-light  text-sm">info@jgdeveloper.com</p>
              </div>
              {/* <div className="mt-8 flex flex-row gap-3 items-end">
        ...
        <div className="w-full flex justify-center text-gray-400 text-sm font-light mb-3 items-center">
          <p>All right reserved &copy; 2025 JG AI R&D</p>
        </div>
      </div>
    </div >
  );
